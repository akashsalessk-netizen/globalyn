  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f8fc] text-slate-900">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute -right-40 top-[250px] h-[500px] w-[500px] rounded-full bg-sky-300/25 blur-[150px]" />

        <div className="absolute bottom-[-250px] left-[30%] h-[550px] w-[550px] rounded-full bg-pink-200/30 blur-[160px]" />
      </div>
      ...
      <header className="sticky top-0 z-50 border-b border-white/60 bg-white/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
          ...
          <Link
            href="/admin"
            className="rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-black text-slate-800 shadow-sm"
          >
            ← Dashboard
          </Link>
        ...
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 sm:py-16">
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <div>
              ...
              <h1 className="mt-6 text-4xl font-black tracking-[-0.04em] text-slate-950 sm:text-5xl md:text-6xl">
                Create something
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-500">
                ...
                from your professional publishing workspace.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        >
            ...
            <div className="rounded-[2rem] border border-white bg-white/85 p-6 shadow-xl sm:p-9">
              ...
              <label className="mt-8 block">
                ...
                <input
                  ...
                  className="mt-3 w-full border-0 border-b-2 border-slate-200 bg-transparent px-0 py-4 text-3xl font-black outline-none focus:border-violet-500"
              ...
              <div className="border-b border-slate-200 bg-slate-50 p-4 sm:p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <select
                    ...
                    className="h-10 rounded-xl border border-violet-200 bg-white px-3 text-sm font-bold text-violet-700 outline-none transition hover:border-violet-400 focus:ring-2 focus:ring-violet-100"
                  >
                    <option value="" disabled>
                      Text Size
                    </option>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    {COLORS.map((color) => (
                      ...
                      <button
                        ...
                        className="h-7 w-7 rounded-full border-2 border-white shadow-sm ring-1 ring-slate-200 transition hover:scale-110"
                        style={{
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    {HIGHLIGHTS.map((color) => (
                      ...
                      <button
                        ...
                        className="rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-bold transition hover:scale-105"
                        style={{
                          backgroundColor: color.value,
                        }}
                      >
          ...
          <aside className="space-y-6 xl:sticky xl:top-24 xl:h-fit">
              ...
              <div className="mt-6">
                ...
                <div className="mt-3 relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-violet-500 focus:ring-4 focus:ring-violet-100"
                  />
                    ...
                    <button
                      ...
                      className={`rounded-full px-3 py-1.5 text-xs font-bold transition ${
                        category === item
                          ...
                          : "border border-slate-200 bg-slate-50 text-slate-500 hover:border-violet-300 hover:bg-violet-50 hover:text-violet-700"
                      }`}
                    >
                      {item}
                    </button>
              ...
              {imagePreview ? (
                ...
                <div className="mt-5">
                  ...
                  <button
                    type="button"
                    onClick={removeImage}
                    className="mt-4 w-full rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm font-bold text-red-600"
                  >
                    Remove image
                  </button>
            ...
            <Link
              href="/admin"
              className="flex w-full justify-center rounded-xl border border-slate-200 bg-white px-5 py-3.5 text-sm font-black text-slate-600 transition hover:border-violet-300 hover:text-violet-700"
            >
              Cancel and return
            </Link>
