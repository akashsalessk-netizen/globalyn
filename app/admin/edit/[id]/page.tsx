      ...
      <div className="space-y-7">
        ...
        <div className="rounded-[2rem] border border-white bg-white/85 p-6 shadow-xl sm:p-9">
          ...
          <label className="mt-8 block">
            ...
            <div className="mt-3 flex overflow-hidden rounded-xl border border-slate-200 bg-slate-50">

              <span className="flex items-center border-r border-slate-200 px-4 text-sm font-bold text-slate-400">
                /blog/
              </span>
              ...
              <input
                ...
                className="min-w-0 flex-1 bg-white px-4 py-3 text-sm font-semibold outline-none"
        ...
        <div className="rounded-[2rem] border border-white bg-white p-6 shadow-lg">
          ...
          <div className="mt-6">
            ...
            <input
              ...
              className="mt-3 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold outline-none focus:border-violet-500"
            />
          ...
          {imagePreview ? (
            ...
            <div className="mt-5">
              ...
              <button
                ...
                className="mt-4 w-full rounded-xl border border-violet-200 bg-violet-50 px-4 py-3 text-sm font-bold text-violet-700 transition hover:bg-violet-100"
              >
                📁 Replace Image
              </button>
            ...
            <button
              ...
              className="mt-5 flex w-full cursor-pointer flex-col items-center rounded-2xl border-2 border-dashed border-slate-200 px-6 py-10 text-center transition hover:border-violet-300 hover:bg-violet-50/50"
            >
