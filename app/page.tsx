      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-8 sm:py-4">
          ...
          <Link href="/" className="flex min-w-0 items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 text-lg font-black text-white shadow-lg sm:h-11 sm:w-11">
              G
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              onClick={saveArticle}
              disabled={saving}
              className="rounded-xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 px-3 py-2.5 text-xs font-bold text-white shadow-lg transition hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-60 sm:px-5 sm:text-sm"
            >
              {saving ? "Saving..." : "💾 Save"}
            </button>
        ...
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white px-4 py-3 shadow-sm sm:px-5 sm:py-4">
              ...
              <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white px-4 py-3 shadow-sm sm:px-5 sm:py-4">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-8 sm:py-12">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-8">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/40 sm:rounded-3xl sm:p-8">
              ...
              <div className="mt-7">
                ...
                <input
                  ...
                  className="mt-3 w-full rounded-xl border border-slate-300 px-4 py-3 text-base font-semibold outline-none transition focus:border-purple-500 focus:ring-4 focus:ring-purple-100 sm:py-4 sm:text-lg"
                />
              ...
              <div className="mt-7">
                ...
                <div className="mt-3 flex overflow-hidden rounded-xl border border-slate-300">
                  ...
                  <span className="flex shrink-0 items-center border-r border-slate-200 bg-gradient-to-r from-blue-50 to-purple-50 px-3 text-xs font-bold text-purple-500 sm:px-4 sm:text-sm">
                    /blog/
                  </span>
                  ...
                  <input
                    ...
                    className="min-w-0 flex-1 px-3 py-3 text-sm font-semibold outline-none sm:px-4 sm:py-4"
                  />
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/40 sm:rounded-3xl sm:p-8">
              ...
              {editorMode === "edit" ? (
                ...
                <div className="mt-5 overflow-hidden rounded-xl border border-slate-300">
                  ...
                  <div className="flex flex-wrap gap-2 border-b border-slate-200 bg-slate-50 p-3">
                    ...
                    <button
                      ...
                      className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-black hover:bg-slate-100"
                      title="Bold"
                    >
                      B
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-bold italic hover:bg-slate-100"
                      title="Italic"
                    >
                      I
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-bold underline hover:bg-slate-100"
                      title="Underline"
                    >
                      U
                    </button>
                  ...
                  <div
                    ...
                    className="min-h-[500px] w-full px-4 py-5 text-base leading-8 text-slate-700 outline-none sm:min-h-[600px] sm:px-5"
                  />
                ...
                <div
                  className="prose prose-slate mt-5 max-w-none rounded-xl border border-purple-100 bg-gradient-to-br from-white to-purple-50 p-5 leading-8 sm:p-8"
          ...
          <aside className="space-y-6 lg:sticky lg:top-24 lg:h-fit">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 p-6 text-white shadow-2xl sm:rounded-3xl">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/40 sm:rounded-3xl">
